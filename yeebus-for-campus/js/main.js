...
window.addEventListener('scroll', function() {
	...
	if(position.top < (window.innerHeight) && position.bottom >= -400) {
...
$(window).on('resize', function() {
  if ($(window).width()<768) {
    ...
    window.addEventListener('scroll', function() {
      ...
      if(position.top < (window.innerHeight) && position.bottom >= -700) {
        $('.purple_backdrop').css("opacity", "1");
      }else{
        //console.log('Element is not visible');
        $('.purple_backdrop').css("opacity", "0");
    ...
    window.addEventListener('scroll', function() {
      ...
      if(position.top < (window.innerHeight - 100) && position.bottom >= -400) {
        $('.purple_backdrop').css("opacity", "1");
      }else{
        //console.log('Element is not visible');
        $('.purple_backdrop').css("opacity", "0");
